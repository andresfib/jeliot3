...
public class ResourceBundles {
    ...
    /**
     * Resource bundle for ConAn
     */
    private static ResourceBundle conAnMessages;
    ...
    public static ResourceBundle getConAnResourceBundle() {
        if (conAnMessages == null) {
            conAnMessages = ResourceBundle.getBundle(
                    "jeliot.conan.resources.messages", Locale.getDefault());
        }

        return conAnMessages;
    }
