...
public class OutputConsole extends JTextPane {
    ...
    public final JScrollPane container = new JScrollPane(this) {
        ...
        public Dimension getMaximumSize() {
            ...
            return new Dimension(sms.width, model == null ? sms.height : model
                    .getMaximumSize().height);
        }

        public Dimension getPreferredSize() {
            Dimension sps = super.getPreferredSize();
            return new Dimension(sps.width, model == null ? sps.height : model
    ...
    public OutputConsole(Component model) {
        ...
        this.font = new Font(propertiesBundle
                .getStringProperty("font.output.family"), Font.PLAIN, Integer
                .parseInt(propertiesBundle
                        .getStringProperty("font.output.size")));
        setFont(font);
        setEditable(false);
        ...
        TitledBorder title = BorderFactory.createTitledBorder(BorderFactory
                .createLoweredBevelBorder(), messageBundle
                .getString("title.output"));
    ...
    */
    ...
    protected void addStylesToDocument(StyledDocument doc) {
        ...
        //System.out.println(StyleConstants.getFontFamily(def));
        
        Style regular = doc.addStyle("regular", def);
        StyleConstants.setFontFamily(regular, this.font.getFamily());
        StyleConstants.setFontSize(regular, this.font.getSize());

        //System.out.println(StyleConstants.getFontFamily(regular));
        //System.out.println(StyleConstants.getFontSize(regular));
