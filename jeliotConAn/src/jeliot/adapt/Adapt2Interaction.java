...
public class Adapt2Interaction extends BasicInternalUM {
    ...
    public Adapt2Interaction(String userID, String password, String group,
            String sessionID) {
        this.userID = userID;
        this.password = password;
        this.group = group;
        this.sessionID = sessionID;
        this.eventURL = adapt2UMServer + "?usr=" + userID + "&sid=" + sessionID
                + "&grp=" + group + "&svc=&app=" + applicationID;
    ...
    public void recordEvent(ModelEvent event) {
        ...
        for (int i = 0; i < entries.length; i++) {
            ...
            try {
                ...
                System.out
                        .println("Failed to update the ADAPT2 server with activity");
                e.printStackTrace();
            }
        }
