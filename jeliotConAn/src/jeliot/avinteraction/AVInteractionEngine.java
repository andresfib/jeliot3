...
public class AVInteractionEngine {
    ...
    protected static AVInteractionEngine engine = null;
     ...
     * @throws Exception
     */
    protected AVInteractionEngine(JFrame parent, UMInteraction userModel) throws Exception {
    	super();
     	this.parent = parent;
    ...
    public static AVInteractionEngine createAVInteractionEngine(JFrame parent, UMInteraction userModel) throws Exception{
    	if(engine==null){
    		return new AVInteractionEngine(parent, userModel);
    	}else{
    		return engine;
    	}
    }
     ...
     */
    public void addMCQuestion(String id, String groupId, String questionText, String[] answer, int[] subpoints, 
    		int overallPoints, String[] comments, int[] correctAnswers, Integer[] concepts) {
