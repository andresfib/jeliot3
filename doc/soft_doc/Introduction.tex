...
\item \p{super()} method calls at the beginning of a constructor.
\end{itemize}
...
\begin{itemize}
\item Values of type \p{String}, all primitive types.
...
\item All the control statements (\p{if}, \p{while}, etc.) except \p{switch} statement
and conditional expression (\p{exp?exp1:exp2}).
