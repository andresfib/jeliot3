...
equivalent in \p{ECodeUtilities}, where the value is actually read from the
pipe. An m-code command named \p{INPUT} has been defined to request data of
...
string to the Director with the command \p{OUTPUT}.
\end{itemize}
