...
import org.python.parser.ast.operatorType;
import org.python.parser.ast.stmtType;

public class CodeEvaluator extends Visitor
...
*/
    ...
    public CodeEvaluator(Module module, boolean print_results) {
        this.module = module;
    ...
    // TODO: added. Updated the return value to Object
    public Object set(SimpleNode node) throws Exception {
        int tmp = storeTop();
        Object returnVal = set(node, tmp);
        code.aconst_null();
        code.astore(tmp);
        code.freeLocal(tmp);
    ...
    boolean inSet = false;
    public Object set(SimpleNode node, int tmp) throws Exception {
    ...
    public void parse(modType node, org.python.compiler.Code code,
...
//MCodeUtilities.setWriter(new PrintWriter(System.out));
        ...
        if (node.values != null)
        {
        	String args[] = new String[node.values.length];
...
//System.out.println("bs:" + bs);
    ...
    public static void makeStrings(org.python.compiler.Code c, String[] names, int n)
        throws IOException
    {
    /*    c.iconst(n);
