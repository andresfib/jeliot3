...
public class ActorFactory {
	...
	private Font messageFont =
		new Font(
			bundle.getString("font.message.family"),
			Font.BOLD,
	...
	private Font indexFont =
		new Font(
			bundle.getString("font.index.family"),
			Font.BOLD,
			Integer.parseInt(bundle.getString("font.index.size")));
	/**
	 *
	 */
	private Font SMIFont =
		new Font(
			bundle.getString("font.SMI.family"),
			Font.BOLD,
			Integer.parseInt(bundle.getString("font.SMI.size")));
	/**
	 *
	 */
	private Font OMIFont =
		new Font(
			bundle.getString("font.OMI.family"),
			Font.BOLD,
	...
	private Font ACFont =
		new Font(
			bundle.getString("font.AC.family"),
			Font.BOLD,
			Integer.parseInt(bundle.getString("font.AC.size")));
	/**
	 *
	 */
	private Font LATFont =
		new Font(
			bundle.getString("font.LAT.family"),
			Font.BOLD,
	 ...
	 */
	private int margin =
		Integer.parseInt(bundle.getString("actor_factory.margin"));

	/**
	 *
	 */
	private Color messagebc =
		new Color(
			Integer
				.decode(bundle.getString("color.message.background"))
				.intValue());
	/**
	 *
	 */
	private Color messagefc =
		new Color(
			Integer
				.decode(bundle.getString("color.message.foreground"))
				.intValue());
	...
	private Color trueColor =
		new Color(Integer.decode(bundle.getString("color.true")).intValue());
	/**
	 *
	 */
	private Color falseColor =
		new Color(Integer.decode(bundle.getString("color.false")).intValue());
	...
	private Color opColor =
		new Color(
			Integer.decode(bundle.getString("color.operator")).intValue());
	/**
	 *
	 */
	private Color methodStageColor =
		new Color(
			Integer
				.decode(bundle.getString("color.method_stage.background"))
				.intValue());
	/**
	 *
	 */
	private Color objectStageColor =
		new Color(
			Integer
				.decode(bundle.getString("color.object_stage.background"))
				.intValue());
	/**
	 *
	 */
	private Color SMIColor =
		new Color(
			Integer
				.decode(bundle.getString("color.SMI.background"))
				.intValue());
	/**
	 *
	 */
	private Color variableForegroundColor =
		new Color(
			Integer
				.decode(bundle.getString("color.variable.foreground"))
				.intValue());
	/**
	 *
	 */
	private Color valueForegroundColor =
		new Color(
			Integer
				.decode(bundle.getString("color.value.foreground"))
				.intValue());
	/**
	 *
	 */
	private Color OMIColor =
		new Color(
			Integer
				.decode(bundle.getString("color.OMI.background"))
				.intValue());
	/**
	 *
	 */
	private Color ACColor =
		new Color(
			Integer.decode(bundle.getString("color.AC.background")).intValue());
	/**
	 *
	 */
	private Color bubbleColor =
		new Color(
			Integer
				.decode(bundle.getString("color.bubble.background"))
				.intValue());
	/**
	 *
	 */
	private Color LATForegroundColor =
		new Color(
			Integer
				.decode(bundle.getString("color.LAT.foreground"))
				.intValue());
	/**
	 *
	 */
	private Color LATBackgroundColor =
		new Color(
			Integer
				.decode(bundle.getString("color.LAT.background"))
				.intValue());
	...
	private Color[] valColor =
		{
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.boolean"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.byte"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.short"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.int"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.long"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.char"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.float"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.double"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.value.background.string"))
					.intValue()),
			new Color(
				Integer
					.decode(
						bundle.getString("color.value.background.reference"))
					.intValue())};
	...
	private Color[] varColor =
		{
			new Color(
				Integer
					.decode(
						bundle.getString("color.variable.background.boolean"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.variable.background.byte"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.variable.background.short"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.variable.background.int"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.variable.background.long"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.variable.background.char"))
					.intValue()),
			new Color(
				Integer
					.decode(bundle.getString("color.variable.background.float"))
					.intValue()),
			new Color(
				Integer
					.decode(
						bundle.getString("color.variable.background.double"))
					.intValue()),
			new Color(
				Integer
					.decode(
						bundle.getString("color.variable.background.string"))
					.intValue()),
			new Color(
				Integer
					.decode(
						bundle.getString(
							"color.variable.background.reference"))
					.intValue())};
	...
	private String[][] binOpImageName =
		{
			{
				...
				bundle.getString(
					"image.binary_operator.result.multiplication")},
		//multiplication
		{
		...
		//right shift
		{
			bundle.getString("image.binary_operator.unsigned_right_shift"),
				bundle.getString(
					"image.binary_operator.result.unsigned_right_shift")
			},
		...
		//lesser than
		{
			bundle.getString("image.binary_operator.greater_than"),
				bundle.getString(
					"image.binary_operator.result.greater_than")
			},
		//greater than
		{
			bundle.getString("image.binary_operator.lesser_than_or_equals"),
				bundle.getString(
					"image.binary_operator.result.lesser_than_or_equals")
			},
		//lesser than or equals
		{
			bundle.getString("image.binary_operator.greater_than_or_equals"),
				bundle.getString(
					"image.binary_operator.result.greater_than_or_equals")
			},
		...
		//logical or
		{
			bundle.getString("image.binary_operator.logical_xor"),
				bundle.getString(
					"image.binary_operator.result.logical_xor")
			} //logical xor
	};
	...
	private String[][] unaOpImageName =
		...
		//postinc
		{
			bundle.getString("image.unary_operator.postdec"),
				bundle.getString(
					"image.unary_operator.result.postdec")
			} //postdec
	};
	...
	public ActorFactory(ImageLoader iLoad) {
		...
		this.messageImage =
			iLoad.getImage(bundle.getString("image.message.background"));

		setValueFont(
			new Font(
				bundle.getString("font.value.family"),
				Font.BOLD,
				Integer.parseInt(bundle.getString("font.value.size"))));
		setVariableFont(
			new Font(
				bundle.getString("font.variable.family"),
				Font.BOLD,
				Integer.parseInt(bundle.getString("font.variable.size"))));
		setStageFont(
			new Font(
				bundle.getString("font.stage.family"),
				Font.PLAIN,
	...
	public MethodStage produceMethodStage(MethodFrame m) {
		...
		stage.calculateSize(
			getMaxMethodStageWidth(),
			valueHeight + 8 + variableInsets.top + variableInsets.bottom);
	...
	public VariableActor produceVariableActor(Variable v) {
		...
		if (typeInfo != MCodeUtilities.REFERENCE) {
			...
			if (MCodeUtilities.isArray(type)) {
				...
				String resolvedType =
					MCodeUtilities.changeComponentTypeToPrintableForm(ct);
	...
	public VariableActor produceObjectVariableActor(Variable v) {
		...
		if (typeInfo != MCodeUtilities.REFERENCE) {
			...
			ValueActor vact =
				produceValueActor(
					new Value(MCodeUtilities.getDefaultValue(type), type));
	...
	public ValueActor produceValueActor(Value val) {
		...
		if (MCodeUtilities.isPrimitive(type)) {
			...
			if (val instanceof jeliot.lang.Reference) {
				...
				val.getActor() instanceof jeliot.theater.ReferenceActor) {
	...
	public ReferenceActor produceReferenceActor(ReferenceActor cloneActor) {
		...
		ReferenceActor actor =
			new ReferenceActor(cloneActor.getInstanceActor());
	...
	public ArrayActor produceArrayActor(ArrayInstance array) {
		...
		Object valueActors =
			Array.newInstance((new ValueActor()).getClass(), dims);
	 ...
	 *
	 */
	private MessageFormat objectStageTitle =
		new MessageFormat(bundle.getString("title.object_stage"));
