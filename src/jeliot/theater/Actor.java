...
public class Actor implements Cloneable {
	...
	private static Font defaultFont =
		new Font(
			bundle.getString("font.actor.default.family"),
			Font.PLAIN,
	...
	protected int borderWidth =
		Integer.parseInt(bundle.getString("actor.border_width"));
	...
	protected Color fgcolor =
		new Color(
			Integer
				.decode(bundle.getString("color.actor.default.foreground"))
				.intValue());
	...
	protected Color highColor =
		new Color(
			Integer
				.decode(bundle.getString("color.actor.default.highlight"))
				.intValue());
	...
	protected Color borderColor =
		new Color(
			Integer
				.decode(bundle.getString("color.actor.default.border"))
				.intValue());
