 ...
 */
public class MCodeUtilitiesB extends MCodeUtilities{ 

    /**
     * Should be never used. 
     */
    private MCodeUtilitiesB() {
    }
    ...
    public static int resolveType(String type) {
        if (type.equals(boolean.class.getName())
            ...
            return MCodeUtilitiesB.BOOLEAN;

        } else if (type.equals(byte.class.getName())
                || type.equals(Byte.class.getName())) {

            return MCodeUtilitiesB.BYTE;

        } else if (type.equals(short.class.getName())
                || type.equals(Short.class.getName())) {

            return MCodeUtilitiesB.SHORT;

        } else if (type.equals(int.class.getName())
                || type.equals(Integer.class.getName())) {

            return MCodeUtilitiesB.INT;

        } else if (type.equals(long.class.getName())
                || type.equals(Long.class.getName())) {

            return MCodeUtilitiesB.LONG;

        } else if (type.equals(char.class.getName())
                || type.equals(Character.class.getName())) {

            return MCodeUtilitiesB.CHAR;

        } else if (type.equals(float.class.getName())
                || type.equals(Float.class.getName())) {

            return MCodeUtilitiesB.FLOAT;

        } else if (type.equals(double.class.getName())
                || type.equals(Double.class.getName())) {

            return MCodeUtilitiesB.DOUBLE;

        } else if (type.equals(String.class.getName())
                || type.equals("L" + String.class.getName() + ";")) {

            return MCodeUtilitiesB.STRING;

        } else if (type.equals(Void.TYPE.getName()) || type.equals("V")) {

            return MCodeUtilitiesB.VOID;

        } else {

            return MCodeUtilitiesB.REFERENCE;
        }
    }
    ...
    public static boolean isPrimitive(String type) {
        if (Util.visualizeStringsAsObjects()
                && resolveType(type) == MCodeUtilitiesB.STRING) {
            return false;
        }
        if (resolveType(type) != MCodeUtilitiesB.REFERENCE
                && resolveType(type) != MCodeUtilitiesB.VOID) {
            return true;
        }
        return false;
    }
    ...
    public static void write(String str) {
        ...
        if (!CodeEvaluator.isSetPreparing() || token == Code.ERROR) {        
            str = MCodeUtilitiesB.replace(str, "\n", "\\n");
            str = MCodeUtilitiesB.replace(str, "\r", "");
...
System.out.println("MCODE WRITE:" + str);            
    ...
    public static String getValue(String value, String type) {
        if (Util.visualizeStringsAsObjects() && MCodeUtilitiesB.resolveType(type) == MCodeUtilitiesB.STRING) {
            String[] strs = MCodeUtilitiesB.getStringValues(value);
            if (strs != null) {
                return strs[0];
            }            
        }
