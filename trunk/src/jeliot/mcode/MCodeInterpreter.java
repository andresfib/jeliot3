                    ...
                    case Code.A:
                        {
                            ...
                            handleCodeA(expressionCounter, fromExpression, toExpression, value,
                                    type, h);
                    ...
                    case Code.COMP:
                        {
                            ...
                            Highlight h = MCodeUtilities.makeHighlight(tokenizer.nextToken());
                            handleCodeCOMP(expressionCounter, unaryExpressionReference, value,
                                    type, h);
                            break;
                        }
                    ...
                    case Code.PLUS:
                        {
                            ...
                            Highlight h = MCodeUtilities.makeHighlight(tokenizer.nextToken());
                            handleCodePLUS(expressionCounter, unaryExpressionReference, value,
                                    type, h);
                            break;
                        }
                    ...
                    case Code.MINUS:
                        {
                            ...
                            Highlight h = MCodeUtilities.makeHighlight(tokenizer.nextToken());
                            handleCodeMINUS(expressionCounter, unaryExpressionReference, value,
                                    type, h);
                            break;
                        }
                    ...
                    case Code.NO:
                        {
                            ...
                            Highlight h = MCodeUtilities.makeHighlight(tokenizer.nextToken());
                            handleCodeNO(expressionCounter, unaryExpressionReference, value, type,
                                    h);
                            break;
                        }
                    ...
                    case Code.VD:
                        {
                            ...
                            Highlight highlight = MCodeUtilities.makeHighlight(tokenizer
                                    .nextToken());
                            handleCodeVD(variableName, initializerExpression, value, type,
                                    modifier, highlight);
                            break;
                        }
                    ...
                    case Code.OFA:
                        {
                            ...
                            handleCodeOFA(expressionCounter, objectCounter, variableName, value,
                                    type, h);
                            break;
                        }
                    ...
                    case Code.OUTPUT:
                        {
                            ...
                            handleCodeOUTPUT(expressionReference, value, type, breakLine, highlight);
                            break;
                        }
                    ...
                    case Code.AA:
                        {
                            ...
                            handleCodeAA(expressionReference, hashCode, compType, dims, dimensionReferences, dimensionSizes, h);
                            break;
                        }
                    ...
                    case Code.AAC:
                        {
                            ...
                            handleCodeAAC(expressionCounter, expressionReference, dims, cellNumberReferences, cellNumbers, value, type, h);
                            break;
                        }
