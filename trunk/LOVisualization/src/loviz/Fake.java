...
public class Fake implements Visualization {
	...
	public void initialize(javax.swing.JFrame frame, String args[]) throws Exception {
	}

	public javax.swing.JFrame initialize(String args[]) throws Exception {
		String s = "";
	...
	public void load(String fileName) throws java.io.IOException {
		JOptionPane.showMessageDialog(null, "Start a Jeliot animation for program " + fileName);
	}
	...
	public void setOptions(String args[]) {
		...
		for (int i = 0; i < args.length; i++)
			s = s + args[i];
		JOptionPane.showMessageDialog(null, "Set the Jeliot options to " + s);
	}

	// Run from start or run something, step, reset the visualization
	public void runFromStart() throws Exception {
		JOptionPane.showMessageDialog(null, "Run Jeliot from the start");
	}
	...
	public void step(int steps) throws Exception {
		JOptionPane.showMessageDialog(null, "Run Jeliot for " + steps + " steps");
	}

	public void reset() throws Exception {
		JOptionPane.showMessageDialog(null, "Reset Jeliot run");
	}
