...
int**_is a new type of variable for the MCode, it represents the pointer variable of type int. Another pointer variable is int_****_, this represents a pointer to a pointer._**
